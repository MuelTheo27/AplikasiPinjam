...
@section('content')
    ...
    {{-- CONTAINER CARD BOX DENGAN JARAK DARI NAVBAR --}}
    <div
        ...
        @foreach ($filteredRooms as $room)
            <div
                style="background-color: white; border-radius: 0.5rem; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); padding: 1rem; display: flex; gap: 2rem; width: 72%; margin: 0 auto;">
                <div style="width: 50%;">
