...
<head>
    ...
    <style>
        ...
        .filter-input {
            width: 300px; /* Wider filter input */
        ...
        .detail-item strong {
            display: block; /* Make strong a block to put value on new line */
            margin-bottom: 5px;
            color: #555;
        ...
        .organization-name {
            font-size: 14px;
            color: #666;
            margin-bottom: 15px; /* Space below organization */
        }

        .note-display {
            background-color: #f0f0f0; /* Light grey background for note */
            border: 1px solid #ddd;
            padding: 10px 15px;
            border-radius: 5px;
            font-size: 14px;
        ...
        .action-buttons {
            ...
            width: 100%; /* Ensure buttons take full width for alignment */
        }
