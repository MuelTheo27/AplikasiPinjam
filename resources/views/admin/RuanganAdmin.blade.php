    ...
    <div
        ...
        <div style="display: flex; flex-direction: column; align-items: center; gap: 2rem;">
            @php
                ...
                $rooms = [
                    [
                        'roomImage' => 'https://media-public.dekoruma.com/article/2025/03/arsitag-4073945314-1527939251756.jpeg',
            ...
            @foreach($rooms as $room)
                <div
                    ...
                    <div style="width: 50%; display: flex; flex-direction: column; gap: 1rem;">
                        ...
                        <div style="display: flex; justify-content: space-evenly; align-items: center; padding: 0.5rem 1rem; border-radius: 0.375rem; gap: 0.5rem; width: 196px;">
                            <svg width="24" height="24" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.16667 32.375V23.125H30.8333V32.375H27.75V26.2083H9.25V32.375H6.16667ZM4.625 21.5833V16.9583H9.25V21.5833H4.625ZM10.7917 21.5833V4.625H26.2083V21.5833H10.7917ZM27.75 21.5833V16.9583H32.375V21.5833H27.75Z" fill="black"/>
                            </svg>
