  ...
  <div class="form-container">
    <form method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="nama_ruangan" placeholder="Ruangan NTT" required />
      </div>

      <div class="form-group">
        <label>Total Kursi</label>
        <input type="number" name="total_kursi" placeholder="12" required />
      </div>

      <div class="form-group">
        <label>Lokasi</label>
        <input type="text" name="lokasi" placeholder="Wahana Visi Bintaro" required />
      </div>

      <div class="form-group">
        <label>Kelengkapan</label>
        <input type="text" name="kelengkapan" placeholder="Free wifi, Projector, Papan Tulis" />
      </div>

      <div class="form-group">
        <label>Gambar Ruangan</label>
        <input type="file" name="gambar_ruangan" accept="image/png" required />
      </div>
